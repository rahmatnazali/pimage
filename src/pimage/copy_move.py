...
def detect(input_path, block_size=32) -> Tuple[numpy.ndarray, numpy.ndarray]:
    """
    ...
    single_image = image_object.ImageObject(input_path, block_size)
    return single_image.run()


def detect_and_export(input_path, output_path, block_size=32):
    """
    ...
    ground_truth_image, result_image = detect(input_path, block_size)
